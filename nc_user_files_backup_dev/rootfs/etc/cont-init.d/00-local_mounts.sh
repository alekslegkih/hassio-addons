...
# Modified by Aleks Legkih for Nextcloud User Files Backup

bashio::log.notice "This script is used to mount local USB/SATA/SD/NVMe drives for Nextcloud backup"
...
if bashio::config.has_value 'localdisks'; then
    ...
    bashio::log.warning "No localdisks configured"
fi